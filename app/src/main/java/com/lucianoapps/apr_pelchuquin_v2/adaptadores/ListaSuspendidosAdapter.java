...
import com.lucianoapps.apr_pelchuquin_v2.Suspensiones;
...
public class ListaSuspendidosAdapter extends RecyclerView.Adapter<ListaSuspendidosAdapter.ContactoViewHolder> {

    ArrayList<Usuarios> listaContactos;
    ArrayList<Usuarios> listaOriginal;

    public ListaSuspendidosAdapter(ArrayList<Usuarios> listaContactos) {
    ...
    public class ContactoViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView viewMedidor, viewTelefono, viewCorreo;
        ...
        public ContactoViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, Suspensiones.class);
                    intent.putExtra("ID", listaContactos.get(getAdapterPosition()).getId_medidor());
                    intent.putExtra("Servicio", "Suspender");
