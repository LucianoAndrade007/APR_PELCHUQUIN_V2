...
public class ListaReposicionAdapter extends RecyclerView.Adapter<ListaReposicionAdapter.ContactoViewHolder> {

    ArrayList<Usuarios> listaContactos;
    ArrayList<Usuarios> listaOriginal;

    public ListaReposicionAdapter(ArrayList<Usuarios> listaContactos) {
        ...
        public ContactoViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("Servicio", "Reponer");
